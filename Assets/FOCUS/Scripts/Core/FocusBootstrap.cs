...
namespace FocusSim.Core
{
    public sealed class FocusBootstrap : MonoBehaviour
    {
            ...
            out Rigidbody rb)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(bodyVisual.GetComponent<Renderer>(), new Color(0.15f, 0.15f, 0.2f));
            ...
            out Transform wheelVisual)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(visual.GetComponent<Renderer>(), new Color(0.08f, 0.08f, 0.08f));
        ...
        private static List<LanePath> CreateRoadNetwork(Transform parent, List<Transform> intersections)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(ground.GetComponent<Renderer>(), new Color(0.29f, 0.34f, 0.29f));
        ...
        private static void CreateRoadVisual(Transform parent, Vector3 position, Vector3 size)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(road.GetComponent<Renderer>(), new Color(0.14f, 0.14f, 0.15f));
        ...
        private static void CreateRoadStripe(Transform parent, Vector3 position, Vector3 size)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(stripe.GetComponent<Renderer>(), new Color(0.92f, 0.92f, 0.85f));
        ...
        private static void CreateBuildingBlocks(Transform parent)
        {
            ...
            for (int i = 0; i < positions.Length; i++)
            {
                ...
                RuntimeMaterialHelper.ApplyColor(building.GetComponent<Renderer>(), new Color(0.22f + (i % 3) * 0.06f, 0.23f, 0.27f));
            }
        }
        ...
        private static void CreateTrafficSignal(Transform parent, out TrafficLightController lightController, out Transform stopLine)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(pole.GetComponent<Renderer>(), new Color(0.26f, 0.26f, 0.28f));
            ...
            RuntimeMaterialHelper.ApplyColor(lightVisual.GetComponent<Renderer>(), new Color(0.2f, 0.9f, 0.2f));
            ...
            RuntimeMaterialHelper.ApplyColor(stopLineGo.GetComponent<Renderer>(), Color.white);
        ...
        private static void CreatePedestrian(Transform parent, TrafficLightController trafficLight)
        {
            ...
            RuntimeMaterialHelper.ApplyColor(pedRoot.GetComponent<Renderer>(), new Color(0.87f, 0.73f, 0.63f));
